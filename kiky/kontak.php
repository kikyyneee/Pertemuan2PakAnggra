<html>
    ...
    <body>
        ...
        <table border="1" width="1200px" height="700px" align="center">
            ...
            <tr height="150px">
                <td>
                    <img src="img/pict1.png" width="100%" height="100%">
                </td>    
            </tr>
            ...
            <tr height="450px">
                <td valign="top">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Nama Sekolah : SMKN 4 KOTA BOGOR</td>
                        </tr>
                        <tr>
                            <td>Instagram : @smkn4kotabogor</td>
                        </tr>
                        <tr>
                            <td>No Telepon : 08xxxxxx</td>
                        </tr>
                        <tr>
                            <td>Youtube : SMKN 4 KOTA BOGOR</td>
                        </tr>
                        <tr>
                            <td>M . Rizky Maulana . D / XI RPL 2 / 19</td>
                        </tr>

                        <td>
                            <embed autostart="false" height="100%" src="img/1.png" width="100%"></embed>
                        </td>
                    </table>
                </td>    
            </tr>
